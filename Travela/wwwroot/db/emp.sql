...
INSERT INTO `department` VALUES (1,'sdx',1),(2,'fdgbfb',1),(3,'GFG',0),(4,'CE',0),(5,'IT',0),(6,'HR',0),(7,'Marketing',0),(8,'Testing',0),(9,'CE',0);
...
INSERT INTO `emp` VALUES (1,'rutvik','nathani',12,'MAle',1,0,1,''),(2,'dsfvd','dvfxz',2,'Male',5,0,1,NULL),(3,'jahanvi','modi',12,'Female',4,0,1,'/Images/145c3b07-5108-4133-8c2f-3dd7e7b7b0e6.jpg'),(4,'jahanvi','modi',20,'Female',4,1,0,'/Images/d99f9a40-c7a9-403d-b1e2-fa47a5f459ef.jpg'),(5,'dcX ','cxz',32,'Male',4,1,0,'/Images/97b1bdde-bf69-40e7-89e7-ad185457578b.jpg');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `GetDep` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetDep`()
BEGIN
...
BEGIN
    SELECT * FROM emp WHERE isActive =  1 && IsDelete = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM emp WHERE EmployeeId = EmpId) THEN
    ...
    ELSE
        ...
        INSERT INTO emp ( FirstName, LastName, DepId, Age, Gender, isActive, image_path)
...
BEGIN
	 SELECT emp.*, dept.DepName FROM emp inner join department dept on emp.DepId = dept.departmentId WHERE emp.isDelete = 0;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
   update emp set isactive=0,isdelete=1  where EmployeeId=EmpId ;
...
-- Dump completed on 2024-06-28 15:29:05
