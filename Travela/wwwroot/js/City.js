...
//                    var deleteButton = "<a class=\"btn mb-0 btn-outline-danger btndelete\" title=\"Delete\" onclick=\"DeleteData('" + row.cityId + "', '" + row.cityName + "');\">Delete<i class=\"fas fa-trash-alt\"></i></a>";
